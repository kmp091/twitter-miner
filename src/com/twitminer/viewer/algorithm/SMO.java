...
public class SMO implements Classifier {
	...
	private static final String disgustedPath = "disgusted-model.model";
	private static final String happyPath = "happy-model.model";
	private static final String sadPath = "sad-model.model";
	private static final String surprisedPath = "surprise-model.model";
	...
	public SMO(EmotionDAO emotion) throws Exception {
	...
	@SuppressWarnings("unused")
	private weka.classifiers.Classifier getClassifierModel(String filePath) throws Exception {
		return this.reader.getModelObj(filePath);
	}
