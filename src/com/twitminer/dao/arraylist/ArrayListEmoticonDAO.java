...
public class ArrayListEmoticonDAO extends EmoticonDAO {
	...
	ArrayListEmoticonDAO () {
		...
		tempEmo.setEmoticon(">:]");
		tempEmo.setEmotionId(EmotionDAO.HAPPY);
		...
		tempEmo.setEmoticonId(EmotionDAO.HAPPY);
		emoticons.add(tempEmo);
		tempEmo = new Emoticon();
		...
		tempEmo.setEmoticon(">:[");
		tempEmo.setEmoticonId(EmotionDAO.SAD);
		emoticons.add(tempEmo);*/
		/*tempEmo = new Emoticon();
		...
		tempEmo.setEmoticon(":-||");
		tempEmo.setEmoticonId(EmotionDAO.DISGUST);
		emoticons.add(tempEmo);
		tempEmo = new Emoticon();
		...
		tempEmo.setEmoticon(">:o");
		tempEmo.setEmoticonId(EmotionDAO.SURPRISE);
		emoticons.add(tempEmo);
		tempEmo = new Emoticon();
